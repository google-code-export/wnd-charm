...
{
    my $self = shift;
    my $pkg = shift || "BoincDaemon::ClientConn";
...
sub product_tokens
{
    "libwww-perl-daemon/$BoincDaemon::VERSION";
}



package BoincDaemon::ClientConn;

use vars qw(@ISA $DEBUG);
use IO::Socket ();
@ISA=qw(IO::Socket::INET);
*DEBUG = \$BoincDaemon::DEBUG;
...
sub send_status_line
{
    ...
    $proto   ||= $BoincDaemon::PROTO || "HTTP/1.1";
